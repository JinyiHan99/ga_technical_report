...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.14\textwidth} >{\raggedright\arraybackslash}p{0.17\textwidth} >{\raggedright\arraybackslash}p{0.20\textwidth} >{\raggedright\arraybackslash}p{0.20\textwidth} >{\raggedright\arraybackslash}p{0.23\textwidth}}
...
\caption[]{\textbf{Representative task-level substitutions from specialized tools to GA atomic-tool compositions} (continued).} \\
\toprule
\textbf{Source} & \textbf{Specialized Tool / Capability} & \textbf{Representative Task} & \textbf{GA Replacement Composition} & \textbf{Argument} \\
\midrule
\endhead
